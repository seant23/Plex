...
namespace Plex {
	...
	require_once('lib/File_Util.php');
	...
	Plex::$ABSOLUTE_BASE_URL = ($_SERVER['SERVER_PORT']==80?'http://':'https://') . $_SERVER["SERVER_NAME"] . Plex::$BASE_URL;
	...
	if(!(isset($_REQUEST['start_session']) && $_REQUEST['start_session']=='false')) {
		session_start();
	}
	...
	if(!(isset($_REQUEST['log_last_access']) && $_REQUEST['log_last_access']=='false')) {
		if(Employee::isLoggedIn()) {
			Employee::updateLastAccessTime();
		}
	} 
}
